...
DO $$ BEGIN
    DROP POLICY IF EXISTS "Public read permissions" ON public.app_permissions;
    CREATE POLICY "Public read permissions" ON public.app_permissions FOR SELECT USING (true);

    DROP POLICY IF EXISTS "Public read roles" ON public.app_roles;
    CREATE POLICY "Public read roles" ON public.app_roles FOR SELECT USING (true);

    DROP POLICY IF EXISTS "Public read role_permissions" ON public.app_role_permissions;
    CREATE POLICY "Public read role_permissions" ON public.app_role_permissions FOR SELECT USING (true);

    DROP POLICY IF EXISTS "Public read user_roles" ON public.app_user_roles;
