...
const ADVENTURE_CATEGORIES: AdventureCategory[] = [
  ...
  { id: 'skiing',   name: 'Skiing',    description: 'Alpine and cross-country experiences.',image: '/images/skiing_norway.jpg',               count: 120 },
  { id: 'kayaking', name: 'Kayaking',  description: 'Fjords and coastal exploration.',       image: '/images/geirangerfjord_kayak.jpg',        count: 85  },
  { id: 'cycling',  name: 'Cycling',   description: 'Scenic roads and mountain routes.',     image: '/images/preikestolen_hikers.jpg',         count: 150 },
  { id: 'fishing',  name: 'Fishing',   description: 'Freshwater and coastal fishing.',       image: '/images/alesund_fisherman.jpg',           count: 320 },
