      ...
      if (!dbError && dbData && dbData.length > 0) {
        ...
        list = dbData.map((row) => {
          ...
          return {
            ...
            img: row.img || matchedFallback?.img || '/images/placeholder.jpg',
            gallery: matchedFallback?.gallery || [row.img || '/images/placeholder.jpg'],
    ...
    try {
      ...
      if (data && !error) {
        ...
        return {
          ...
          img: data.img || matchedFallback?.img || '/images/placeholder.jpg',
          gallery: matchedFallback?.gallery || [data.img || '/images/placeholder.jpg'],
